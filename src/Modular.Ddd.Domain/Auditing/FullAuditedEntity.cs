...
namespace Modular.Ddd.Domain.Auditing
{
    ...
    public abstract class FullAuditedEntity<TUser, TUserKey> : 
        AuditedEntity<TUser, TUserKey>, 
    ...
    /// <typeparam name="TUser">Type of the user</typeparam>
    /// <typeparam name="TUserKey">The user's primary key type</typeparam>
    public abstract class FullAuditedEntity<TEntityPrimaryKey, TUser, TUserKey> :
        AuditedEntity<TEntityPrimaryKey, TUser, TUserKey>,
