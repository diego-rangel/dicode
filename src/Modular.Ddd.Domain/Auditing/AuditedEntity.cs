...
namespace Modular.Ddd.Domain.Auditing
{
    ...
    public abstract class AuditedEntity<TUser, TUserKey> : 
        CreationAuditedEntity<TUser, TUserKey>, 
    ...
    /// <typeparam name="TUser">Type of the user</typeparam>
    /// <typeparam name="TUserKey">The user's primary key type</typeparam>
    public abstract class AuditedEntity<TEntityPrimaryKey, TUser, TUserKey> :
        CreationAuditedEntity<TEntityPrimaryKey, TUser, TUserKey>,
